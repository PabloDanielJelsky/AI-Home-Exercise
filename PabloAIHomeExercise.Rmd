...
```{r}
library(gifski)
png_files <- list.files("/home/pablo/Documents/Software Engineering/AI home exercise/Solution/output/agent/", pattern = ".*png$", full.names = FALSE)
...
gifski(png_files, gif_file = "/home/pablo/Documents/Software Engineering/AI home exercise/Solution/output/agent/1_2_2_AgentOverTime.gif", delay = 1)
